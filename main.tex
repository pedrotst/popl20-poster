...
\end{tabular}
 ...
 \textbf{no universe universe hierarchy}, all of this implemented in an extrinsic type theory.\\
...
\block{Let's talk about Coquedille}{
  ...
  Coquedille is a translater from Coq to Cedille.
  \textbf{We implement Coquedille in Coq} itself, this allows us to \textbf{use metacoq} to access the abstract syntax tree of the gallina terms.

  Since Coq and Cedille are based on the Calculus of Constructors, most of the translation is straightforward!
...
\column{.47}
\block{Ok... What can you do with it?}{
...
\begin{tabular}[t]{p{.6\linewidth}r}
    ...
    \textit{If you want to see the proof written with tactics, take a look at the project github\textsuperscript{2}}
...
\end{tabular}
 ...
 Bohm-out algorithm\textsuperscript{3}. If the terms being compared are not $\beta\eta$-equivalent, $\delta$
...
\textsuperscript{2} {\mbox{\url{https://github.com/pedrotst/coquedille}}}.

\textsuperscript{3} H. Barendregt, The Lambda Calculus; Its Syntax and Semantics.
